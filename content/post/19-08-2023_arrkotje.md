...
Because of how my setup works, you have to download the movies before that you are actually able to watch them. This part took the longest to setup, so it'll take the longest to explain.
...
Once it found suitable media that matches my requirements, it gets sent too qbittorrent. This tool is responsible for downloading the media.
